...
while True:
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0) and (int(classes[i]) == 4)):            
                ...
                #To get the centre of the object.
                x_deviation = 0
                y_deviation = 0
                ...
                label_ymax = max(ymax, labelSize[1] + 10)  # Make sure not to draw label too close to top of window
                ...
                cv2.putText(frame, directionlabel, (winmidx-60, 475), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0),
                        2)
